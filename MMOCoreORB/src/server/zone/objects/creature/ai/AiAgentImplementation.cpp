...
void AiAgentImplementation::fillAttributeList(AttributeListMessage* alm, CreatureObject* player) {
	...
	if (player->getPlayerObject() && player->getPlayerObject()->hasGodMode()) {
		...
		*/
		...
		alm->insertAttribute("rpstat.constitution", getSkillMod("rp_constitution"));
		alm->insertAttribute("rpstat.dexterity", getSkillMod("rp_dexterity"));
		alm->insertAttribute("rpstat.intelligence", getSkillMod("rp_intelligence"));
		alm->insertAttribute("rpstat.mindfulness", getSkillMod("rp_mindfulness"));
		...
		alm->insertAttribute("rpforce.lightsaber", getSkillMod("rp_lightsaber"));
		alm->insertAttribute("rpforce.sense", getSkillMod("rp_sense"));
		alm->insertAttribute("rpforce.lightning", getSkillMod("rp_lightning"));
		alm->insertAttribute("rpforce.telekinesis", getSkillMod("rp_telekinesis"));

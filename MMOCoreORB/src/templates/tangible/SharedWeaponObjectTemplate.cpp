...
void SharedWeaponObjectTemplate::readObject(LuaObject* templateData) {
	...
	itemValue = templateData->getStringField("ammoType");
	...
	noFlurryAttack			= templateData->getBooleanField("noFlurryAttack");
	noAimedAttack			= templateData->getBooleanField("noAimedAttack");
	lightsaberResistant		= templateData->getBooleanField("lightsaberResistant");
	noDodgeReaction			= templateData->getBooleanField("noDodgeReaction");
	noDefendReaction		= templateData->getBooleanField("noDefendReaction");
	noParryReaction			= templateData->getBooleanField("noParryReaction");
}

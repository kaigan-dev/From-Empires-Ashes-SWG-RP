npc_template = {
	...
	equipmentTemplates = {
		{"rp_human_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_human_female", {"faction/rebel/tatooine_trooper"}},
		{"rp_bothan_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_bothan_female", {"faction/rebel/tatooine_trooper"}},
		{"rp_moncal_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_moncal_female", {"faction/rebel/tatooine_trooper"}},
		{"rp_sullustan_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_sullustan_female", {"faction/rebel/tatooine_trooper"}},
		{"rp_twilek_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_twilek_female", {"faction/rebel/tatooine_trooper"}},
		{"rp_zabrak_male", {"faction/rebel/tatooine_trooper"}},
		{"rp_zabrak_female", {"faction/rebel/tatooine_trooper"}},

...
onlineCharactersPerAccount = 20 --How many characters are allowed online from a single account.
...
jukeboxSongs = {
	...
	{ "Bastila's Theme", "sound/music_theme_bastila.snd" },
	{ "Jizz Song 3", "sound/music_cantina_jizz3_loop.snd" },
	{ "Jizz Song 4", "sound/music_cantina_jizz4_loop.snd" },
	{ "Onderon Cantina", "sound/music_cantina_onderon_loop.snd" },
	{ "Taris Upper City Cantina", "sound/music_cantina_taris_loop.snd" },
	{ "Javyar's Cantina", "sound/music_cantina_javyar_loop.snd" },
	{ "Leviathan Imperial March", "sound/music_theme_forcecommander2.snd" },
	{ "Firestar Militia Theme", "sound/music_theme_rogue2.snd" },
	{ "Niamos!", "sound/music_theme_niamos.snd" },
	{ "Imperial March", "sound/mus_imp_march.snd" },
	{ "Plagueis the Wise", "sound/mus_kashyyyk_droid_cave.snd" },
	{ "Anakin's Dark Deeds", "sound/mus_kashyyyk_dead_forest.snd" },
	{ "General Grievous' Theme", "sound/mus_kashyyyk_epic_island.snd" },
	{ "Even the Youngilngs", "sound/mus_kashyyyk_elders_hut.snd" },
	{ "The Sith Lords", "sound/mus_mustafar_hk47_intro.snd" },
	{ "Not just the Men", "sound/mus_neutral_flourish_01.snd" },
	{ "Imperial Preparations", "sound/mus_npe2_mara_jade_empire_intro_lp.snd" },
	{ "Danger", "sound/mus_npe2_station_danger_lp.snd" },
	{ "The Dark Sith", "sound/mus_quest_escort_arrival.snd" },
	{ "Docking", "sound/mus_quest_theme_docking.snd" },
	{ "Force, Evil", "sound/music_credits_imperial.snd" },
	{ "Force, Neutral", "sound/music_credits_neutral.snd" },
	{ "Force, Good", "sound/music_credits_rebel.snd" },
	{ "The Dark Rebellions", "sound/music_dark_alliance.snd" },
	{ "Imperial Attack", "sound/music_imperial_attack.snd" },
	{ "Creepy", "sound/music_jungle_amb.snd" },
	{ "The Battle of Hoth", "sound/music_theme_battle_hoth.snd" },
	{ "Bespin Theme", "sound/music_theme_bespin.snd" },
	{ "Yoda's Theme", "sound/music_theme_yoda.snd"},

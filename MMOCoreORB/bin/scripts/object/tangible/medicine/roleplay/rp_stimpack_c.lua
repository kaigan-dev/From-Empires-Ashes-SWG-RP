object_tangible_medicine_roleplay_rp_stimpack_c = object_tangible_medicine_crafted_shared_crafted_stimpack_sm_s1_c:new {
	gameObjectType = 8236,
...
ObjectTemplates:addTemplate(object_tangible_medicine_roleplay_rp_stimpack_c, "object/tangible/medicine/roleplay/rp_stimpack_c.iff")

...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_infiltrator_armor_infiltrator_s02_leggings, "object/tangible/wearables/armor/infiltrator/armor_infiltrator_s02_leggings.iff")

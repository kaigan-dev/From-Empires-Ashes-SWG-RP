...
ObjectTemplates:addTemplate(object_tangible_deed_rp_ship_deed_rp_sorosuub_space_yacht_deed, "object/tangible/deed/rp_ship_deed/rp_sorosuub_space_yacht_deed.iff")

...
object_tangible_deed_pet_deed_cu_pa_deed = object_tangible_deed_pet_deed_shared_cu_pa_deed:new {
	...
	mountable = 1,
	skillTemplate = "creature_medium",
	equipmentTemplate = "creatures/medium",
}

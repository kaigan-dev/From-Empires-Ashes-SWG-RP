...
object_weapon__ranged_heavy_flamethrower = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/heavy/flamethrower.iff"
}
ObjectTemplates:addClientTemplate(object_weapon__ranged_heavy_flamethrower, "object/weapon/ranged/heavy/flamethrower.iff")
...
object_weapon_roleplay_ranged_carbine_carbine_ewok_crossbow = object_weapon_ranged_rifle_shared_rifle_ewok_crossbow:new {

	--[Info]
	customName = "Ewok Crossbow",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_ranged_carbine_carbine_ewok_crossbow, "object/weapon/roleplay/ranged/carbine/carbine_ewok_crossbow.iff")
...
object_weapon_roleplay_ranged_rifle_dlt19x_rifle = object_weapon_ranged_rifle_shared_rifle_dlt19x:new {

	--[Info]
	customName = "DLT-19X Sniper Rifle",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_ranged_rifle_dlt19x_rifle, "object/weapon/roleplay/ranged/rifle/dlt19x_rifle.iff")
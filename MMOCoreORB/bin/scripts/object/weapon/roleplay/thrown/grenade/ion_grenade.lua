...
object_weapon_roleplay_thrown_grenade_ion_grenade = object_weapon_ranged_grenade_shared_grenade_bug_bomb:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Ion Grenade",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_ion_grenade, "object/weapon/roleplay/thrown/grenade/ion_grenade.iff")
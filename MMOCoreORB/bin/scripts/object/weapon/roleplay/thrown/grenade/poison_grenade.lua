...
object_weapon_roleplay_thrown_grenade_poison_grenade = object_weapon_ranged_grenade_shared_grenade_poison:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Poison Grenade",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_poison_grenade, "object/weapon/roleplay/thrown/grenade/poison_grenade.iff")
...
object_weapon_roleplay_thrown_grenade_fragmentation_grenade = object_weapon_ranged_grenade_shared_grenade_fragmentation_light:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Fragmentation Grenade",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_fragmentation_grenade, "object/weapon/roleplay/thrown/grenade/fragmentation_grenade.iff")
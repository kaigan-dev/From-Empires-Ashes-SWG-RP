...
object_weapon_roleplay_thrown_grenade_thermal_detonator = object_weapon_ranged_grenade_shared_grenade_thermal_detonator:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Thermal Detonator",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_thermal_detonator, "object/weapon/roleplay/thrown/grenade/thermal_detonator.iff")
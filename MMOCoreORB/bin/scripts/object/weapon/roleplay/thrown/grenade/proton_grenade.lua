...
object_weapon_roleplay_thrown_grenade_proton_grenade = object_weapon_ranged_grenade_shared_grenade_proton:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Proton Grenade",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_proton_grenade, "object/weapon/roleplay/thrown/grenade/proton_grenade.iff")
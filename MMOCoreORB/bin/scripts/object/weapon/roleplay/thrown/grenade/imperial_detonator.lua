...
object_weapon_roleplay_thrown_grenade_imperial_detonator = object_weapon_ranged_grenade_shared_grenade_imperial_detonator:new {

	objectMenuComponent = "ThrowGrenadeMenuComponent",

	--[Info]
	customName = "Imperial Detonator",
...
ObjectTemplates:addTemplate(object_weapon_roleplay_thrown_grenade_imperial_detonator, "object/weapon/roleplay/thrown/grenade/imperial_detonator.iff")
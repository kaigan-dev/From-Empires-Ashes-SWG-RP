...
includeFile("weapon/melee/unarmed/unarmed_creature_large.lua")
includeFile("weapon/melee/unarmed/unarmed_creature_colossal.lua")
includeFile("weapon/melee/unarmed/unarmed_sbd.lua")

...
ObjectTemplates:addTemplate(object_weapon_melee_plasma_saber_2h_sword_2h_sword_saber_sariss, "object/weapon/melee/plasma_saber/2h_sword/2h_sword_saber_sariss.iff")

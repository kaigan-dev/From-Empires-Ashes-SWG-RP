object_building_ship_rp_sorosuub_space_yacht = object_building_ship_rp_shared_sorosuub_space_yacht:new {
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = 0, z = 0,  y = 19, cellid = 1, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = -2, z = -3.7,  y = -14.5, cellid = 6, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},

object_building_ship_rp_sorosuub_space_yacht = object_building_ship_rp_shared_sorosuub_space_yacht:new {
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = -2.1, z = -3.7,  y = -16.9, cellid = 6, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = -2.1, z = 1.3, y = -16.9, cellid = 6, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},
		...
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = 2.2, z = 1.2, y = -22.9, cellid = 11, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator.iff", x = 2.2, z = 5.3,  y = -22.9, cellid = 11, ow = 1, ox = 0, oy = 0, oz = 0, containmentType = -1},
	},
}

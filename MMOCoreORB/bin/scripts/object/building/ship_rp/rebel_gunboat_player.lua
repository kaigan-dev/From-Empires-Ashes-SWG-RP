object_building_ship_rp_rebel_gunboat_player = object_building_ship_rp_shared_rebel_gunboat_player:new {
	...
	childObjects = {
		...
		--{templateFile = "object/tangible/ship/roleplay/terminal_ship_exit.iff", x = 1, z = -3.5,  y = 1.2, cellid = 10, ow = -1, ox = 0, oy = -5.96046e-08, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/ship/roleplay/terminal_ship_exit.iff", x = 1, z = -3.5,  y = 1.2, cellid = 10, ow = -0.707107, ox = 0, oy = 0.707107, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/ship/roleplay/terminal_ship_exit.iff", x = 1, z = -3.5,  y = 01.2, cellid = 10, ow = 0.707107, ox = 0, oy = -0.707107, oz = 0, containmentType = -1},
		{templateFile = "object/tangible/ship/roleplay/terminal_ship_exit.iff", x = 1, z = -3.5,  y = 2.2, cellid = 10, ow = 0, ox = 0, oy = 1, oz = 0, containmentType = -1},

...
object_building_naboo_starport_naboo = object_building_naboo_shared_starport_naboo:new {
	gameObjectType = 521,
...
ObjectTemplates:addTemplate(object_building_naboo_starport_naboo, "object/building/naboo/starport_naboo.iff")

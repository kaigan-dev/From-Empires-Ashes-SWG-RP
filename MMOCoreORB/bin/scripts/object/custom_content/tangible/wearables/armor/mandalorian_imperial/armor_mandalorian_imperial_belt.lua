...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_mandalorian_imperial_armor_mandalorian_imperial_belt, "object/tangible/wearables/armor/mandalorian_imperial/armor_mandalorian_imperial_belt.iff")

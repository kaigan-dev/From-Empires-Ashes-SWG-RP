...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_scout_trooper_armor_scout_trooper_utility_belt_gcw, "object/tangible/wearables/armor/scout_trooper/armor_scout_trooper_utility_belt_gcw.iff")

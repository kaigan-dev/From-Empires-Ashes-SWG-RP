planet = {
	...
	landing_points = {
		...
		{"dantooine_khoonda_outskirts_east", "Khoonda City Outskirts East", "rp_dantooine", 1475, 1, -1367, 0, true},
		{"dantooine_khoonda_outskirts_north", "Khoonda City Outskirts North", "rp_dantooine", 1136, 1, -820, 0, true},

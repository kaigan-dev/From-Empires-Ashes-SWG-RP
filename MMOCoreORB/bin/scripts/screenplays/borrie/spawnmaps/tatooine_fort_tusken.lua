RpTatooineFortTuskenScreenPlay = CityScreenPlay:new {
	...
	screenplayName = "RpTatooineFortTuskenScreenPlay",
...
registerScreenPlay("RpTatooineFortTuskenScreenPlay",  true)

function RpTatooineFortTuskenScreenPlay:start()
...
function RpTatooineFortTuskenScreenPlay:spawnSceneObjects() 
	...
	--TAILOR--
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/modern/armoire_modern_style_01.iff", -1424.2, 180, 1927.6, 123, 0, 0, -0.00579456, 0) --Shirts

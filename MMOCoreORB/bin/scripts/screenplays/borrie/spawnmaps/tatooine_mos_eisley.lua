...
function RpTatooineMosEisleyScreenPlay:spawnSceneObjects() 
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/storyteller/prop/pr_ch9_speeder_bike.iff", 817.7, 0.3, 546.4, 0, math.rad(30))
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/tatooine/frn_tatt_chair_cantina_seat_2.iff", 833.8, 0, 525.7, 0, math.rad(90))
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/storyteller/prop/hoth/pr_hoth_toolbox.iff", 819.8, 0.1, 536.3, 0, math.rad(0))
	SceneObject(sObj):setCustomObjectName("Toolbox")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/storyteller/prop/hoth/pr_hoth_toolbox.iff", 831.2, 0, 511.9, 0, math.rad(0))
	SceneObject(sObj):setCustomObjectName("Toolbox")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/loot/collectible/kits/orange_rug_kit.iff", 836.4, 0, 532.6, 0, math.rad(0))
	SceneObject(sObj):setCustomObjectName("Toolbox")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/loot/collectible/kits/orange_rug_kit.iff", 812.2, 0.2, 545.4, 0, math.rad(0))
	SceneObject(sObj):setCustomObjectName("Toolbox")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/storyteller/prop/shared_pr_ch9_droid_r5_powerdown.iff", 820.4, 0, 517.8, 0, math.rad(0))

...
function TutorialScreenPlay:spawnSceneObjects() 
	...
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -4.2, -166.3, 80, 281474993981515, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Jacket")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_jackets")
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -2.2, -166.3, 80, 281474993981515, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Vest")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_vests")
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -0.2, -166.3, 80, 281474993981515, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Robes")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_robes")
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -4.2, -164.3, 80, 281474993981515, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Bodysuits")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_bodysuits")
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -2.2, -164.3, 80, 281474993981515, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Skirts")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_skirts")
	sObj = spawnSceneObject("tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 13.8, -0.2, -164.3, 80, 281474993981515, 0, 0, 0)

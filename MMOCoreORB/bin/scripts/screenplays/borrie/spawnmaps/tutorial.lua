...
function TutorialScreenPlay:spawnCivilians() 
	...
	CivillianGenerator:spawnCivillians(self.screenplayName, "rp_tutorial", waypointList, self.walkpointList, "generic", "spacer")
end
--]]

function TutorialScreenPlay:spawnSceneObjects() 
	--Travel Terminals
	spawnSceneObject("rp_tutorial", "object/tangible/terminal/terminal_travel_rp.iff", 37.7034, 0.8, 18.2259, 808251, 0.891006, 0, 0.453991, 0)
	
	--Signs
	local sObj
	
	--TAILOR--
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -4, 3589, 808274, 1, 0, 0, 0)
	...
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -2, 3589, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Pants")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_pants")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, 0, 3589, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Footwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_footwear")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -4, 3591, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Jacket")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_jackets")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -2, 3591, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Vest")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_vests")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, 0, 3591, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Robes")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_robes")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -4, 3593, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Bodysuits")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_bodysuits")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -2, 3593, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Skirts")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_skirts")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, 0, 3593, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Women's Wear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_women")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -4, 3595, 808274, 1, 0, 0, 0)
	...
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -2, 3595, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Handwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_handwear")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, 0, 3595, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Jewelry")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_jewelry")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -4, 3597, 808274, 0, 0, 1, 0)
	...
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -2, 3597, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Alienwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_alien")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, 0, 3597, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Wookiee Wear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_wookiee")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -4, 3599, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Ithorian Wear I")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_ithorian1")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -2, 3599, 808274, 0, 0, 1, 0)
    ...
    sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -4, 2751, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Shirts")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_shirts")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -2, 2751, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Pants")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_pants")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, 0, 2751, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Footwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_footwear")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -4, 2753, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Jacket")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_jackets")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -2, 2753, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Vest")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_vests")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, 0, 2753, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Robes")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_robes")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -4, 2755, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Bodysuits")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_bodysuits")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -2, 2755, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Skirts")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_skirts")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, 0, 2755, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Women's Wear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_women")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 4847, -4, 2757, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Headwear & Goggles")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_headwear")
	SceneObject(sObj):populateInventoryFromContentList("tailor_goggles")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_armoire_s01.iff", 1869, -2, 2757, 808274, 1, 0, 0, 0)
	SceneObject(sObj):setCustomObjectName("Handwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_handwear")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, 0, 2757, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Jewelry")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_jewelry")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -4, 2759, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Belts, Bandoliers & Aprons")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_misc")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -2, 2759, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Alienwear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_alien")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, 0, 2759, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Wookiee Wear")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_wookiee")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -4, 2761, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Ithorian Wear I")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_ithorian1")
	sObj = spawnSceneObject("rp_tutorial", "object/tangible/furniture/plain/plain_chest_s01.iff", 1869, -2, 2761, 808274, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Ithorian Wear II")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_ithorian2")
...
function SpaceTansariiPointStationScreenPlay:spawnMobiles()
	...
	--Armorsmith
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 1896, -4, 3603, 37, 808256, "rp_zabrak_male", "tsp_vendor_armorsmith", "default", "random", "rpg_shopkeeper")
	...
	--Weaponsmith (Melee)
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 1896, -4, 3600, 267, 808256, "rp_rodian_male", "tsp_vendor_weaponsmith_melee", "default", "random", "rpg_shopkeeper")
	...
	--Weaponsmith (Ranged)	
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 1896, -4, 3597, 121, 808247, "rp_bothan_male", "tsp_vendor_weaponsmith_ranged", "default", "random", "rpg_shopkeeper")
	...
	--Vehicle Vendor
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 1896, -4, 3594, 166, 808251, "rp_human_male", "tsp_vendor_vehicle", "default", "random", "rpg_shopkeeper")
	...
	--Stimpack Vendor
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 1896, -4, 3591, 0.168145, 271, 808257, "rp_moncal_male", "outpost_doctor", "default", "random", "rpg_shopkeeper")
    ...
    --Armorsmith
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 4874, -4, 2765, 37, 808256, "rp_zabrak_male", "tsp_vendor_armorsmith", "default", "random", "rpg_shopkeeper")
	SceneObject(pNpc):setCustomObjectName("An Armorsmith")
	SceneObject(pNpc):setStoredString("vendor:theme", "armorsmith")
	SceneObject(pNpc):setStoredString("vendor:shopList", "shop_armor_tier1")
	
	--Weaponsmith (Melee)
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 4874, -4, 2762, 267, 808256, "rp_rodian_male", "tsp_vendor_weaponsmith_melee", "default", "random", "rpg_shopkeeper")
	SceneObject(pNpc):setCustomObjectName("A Melee Weaponsmith")
	SceneObject(pNpc):setStoredString("vendor:theme", "novice_melee")
	SceneObject(pNpc):setStoredString("vendor:shopList", "shop_weaponsmith_melee_tier1")
	
	--Weaponsmith (Ranged)	
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 4874, -4, 2759, 121, 808247, "rp_bothan_male", "tsp_vendor_weaponsmith_ranged", "default", "random", "rpg_shopkeeper")
	SceneObject(pNpc):setCustomObjectName("A Ranged Weaponsmith")
	SceneObject(pNpc):setStoredString("vendor:theme", "novice_ranged")
	SceneObject(pNpc):setStoredString("vendor:shopList", "shop_weaponsmith_ranged_tier1")
	
	--Vehicle Vendor
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 4874, -4, 2756, 166, 808251, "rp_human_male", "tsp_vendor_vehicle", "default", "random", "rpg_shopkeeper")
	SceneObject(pNpc):setCustomObjectName("A Vehicle Vendor")
	SceneObject(pNpc):setStoredString("vendor:theme", "vehicle")
	SceneObject(pNpc):setStoredString("vendor:shopList", "shop_vehicles")
	...
	--Stimpack Vendor
	local pNpc = spawnRoleplayMobile("rp_tutorial", "rp_convo_npc", 1, 4874, -4, 2753, 0.168145, 271, 808257, "rp_moncal_male", "outpost_doctor", "default", "random", "rpg_shopkeeper")
	SceneObject(pNpc):setCustomObjectName("A Stimpack Vendor")
	SceneObject(pNpc):setStoredString("vendor:theme", "medicine")
	SceneObject(pNpc):setStoredString("vendor:shopList", "shop_medicine_novice")

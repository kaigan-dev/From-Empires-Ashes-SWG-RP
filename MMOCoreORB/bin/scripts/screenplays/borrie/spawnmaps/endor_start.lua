...
function endor_start:spawnSceneObjects() 
	...
	spawnSceneObject("rp_endor", "object/tangible/terminal/terminal_travel_rp.iff", 5965.8, 246.5, -2489.7, 0, -0.3, 0, -0.9, 0)
	spawnSceneObject("rp_endor", "object/tangible/terminal/terminal_travel_rp.iff", 5969.5, 247.5, -2490.9, 0, -0.6, 0, -0.9, 0)
	spawnSceneObject("rp_endor", "object/tangible/terminal/terminal_travel_rp.iff", 5960.7, 246.6, -2490.2, 0, -0.9, 0, -0.9, 0)
	spawnSceneObject("rp_endor", "object/tangible/terminal/terminal_travel_rp.iff", 5957.8, 247, -2489.7, 0, 0.3, 0, -0.9, 0)

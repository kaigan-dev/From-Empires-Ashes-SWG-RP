...
function RpTatooineBestineScreenPlay:spawnCivilians() 
	local waypointList = {
		...
		{447.5, 0, 6632.5, 222, 0, {"sit"}},
		{345.2, 0, 6612.4, 245, 0, {"none"}},
		{520.4, 0, 6557.9, 173, 0, {"none"}},
		...
		{22.1, -0.9, -19.6, 68, 610030373, {"sittable"}},
		{21.9, -0.9, -18.3, 106, 610030373, {"social"}},
		{22.7, -0.9, -17.4, 137, 610030373, {"sittable"}},
		{24.2, -0.9, -21, 359, 610030373, {"sittable"}},

		--Bestine entrance cantina 
		{-0.1, 0.8, 4.3, 197, 610029388, {"none"}}, --barman
		{-8.7, 0.7, 2.6, 153, 610029388, {"social"}},
		{-3.1, -0.2, -5.5, 99, 610029388, {"sittable"}},
		{-0.2, -0.2, -5.8, 257, 610029388, {"sittable"}},
		{-2.2, 0.7, 2.9, 29, 610029388, {"drinker"}},
		{7.5, -0.2, -10.1, 77, 610029388, {"tech"}},
...
sObj = spawnSceneObject("rp_tatooine", "object/tangible/sign/all_sign_city_s03.iff", 43.6, 60.4, 6467.3, 0, 1, 0, -0.8, 0) --junkyard Sign blah
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/modern/chest_modern_style_01.iff", -1.4, 2.2, -16.6, 610029850, 0, 0, 1, 0) --Vest
	SceneObject(sObj):setCustomObjectName("Vest")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_vests")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/modern/chest_modern_style_01.iff", -1.4, 3.7, -16.6, 610029850, 0, 0, 1, 0) --Robes
	SceneObject(sObj):setCustomObjectName("Robes")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("tailor_robes")
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/modern/chest_modern_style_01.iff", -1.4, 5.2, -16.6, 610029850, 0, 0, 1, 0) --Bodysuits
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/plain/plain_armoire_s01.iff", 6.3, 0.4, 2.3, 610029600, 0, 0, 1, 0)
	SceneObject(sObj):setCustomObjectName("Furniture, Plain")
	SceneObject(sObj):setPublicContainer(true)
	SceneObject(sObj):setDispenserContainer(true)
	SceneObject(sObj):populateInventoryFromContentList("furniture_plain")
	
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/plain/plain_armoire_s01.iff", -8.6, 0.4, 2.2, 610029600, 0, 0, 1, 0)
	...
	sObj = spawnSceneObject("rp_tatooine", "object/tangible/furniture/plain/plain_armoire_s01.iff", -8.8, 1, 4.1, 610029601, 0, 0, 0, 0)
	...
	--Jukebox--
	spawnSceneObject("rp_tatooine", "object/tangible/terminal/terminal_jukebox.iff", 7.4, -0.5, -1.1, 610029524, 0, 0, -0.9, 0)
...
function RpTatooineBestineScreenPlay:spawnMobiles()
	...
	setRandomCreatureName(pNpc, "rodian")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 327.1, 0, 6761.6, 9, 0, "jawa", "default", "default", "default") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "rodian")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 330.4, 0, 6764.3, 125, 0, "jawa", "default", "default", "default") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "rodian")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 327.9, 0, 6764.3, 176, 0, "jawa", "default", "default", "default") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "rodian")
	...
	setRandomCreatureName(pNpc, "r5")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 470.6, 0, 6599.1, 322, 0, "r2", "default", "default", "random") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "r2")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 753.3, 0, 6586.9, 112, 0, "r2", "default", "default", "random") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "r2")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 420.4, 0, 6662.3, 209, 0, "r4", "default", "default", "random") --Equip, Skill, Customization
	...
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 413.1, 0, 6607.5, 209, 0, "eg6_power_droid", "default", "default", "default") --Equip, Skill, Customization
	setRandomCreatureName(pNpc, "eg6")
	...
	-- Bestine garrison
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 819.2, 0, 6452.2, 171, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 830.3, 0, 6446.4, 216, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 814.2, 0, 6514.8, 296, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 807.8, 0, 6504.1, 296, 0, "rp_human_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 876.7, 7, 6492.3, 150, 0, "rp_human_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 832.9, 7, 6489.6, 256, 0, "rp_human_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 854.5, 0, 6529.3, 33, 0, "rp_sullustan_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 873.9, 0.2, 6568.2, 209, 0, "rp_zabrak_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 913.4, 1.1, 6529.4, 292, 0, "rp_rodian_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 911.9, 1.1, 6534.8, 169, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	-- general trooper security
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 850.3, 0.1, 6588, 31, 0, "rp_sullustan_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 837.6, 0.1, 6596.7, 40, 0, "rp_sullustan_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 635.7, 0, 6634.1, 28, 0, "rp_moncal_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 574.3, 0, 6630.7, 313, 0, "rp_bith_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 537.1, 0, 6597.1, 20, 0, "rp_gran_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 493.4, 0, 6559, 27, 0, "rp_human_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 421.5, 0, 6629.2, 127, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 373.3, 0, 6728.2, 115, 0, "rp_zabrak_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 381, 0, 6739.3, 80, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 537.4, 0, 6742.1, 126, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 541.6, 0, 6690.5, 312, 0, "rp_rodian_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 627.7, 0, 6517.3, 135, 0, "rp_human_female", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 475.5, 0, 6765.6, 138, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")
	 pNpc = spawnRoleplayMobile("rp_tatooine", "rp_base_npc", 1, 477.8, 0, 6768.2, 122, 0, "rp_human_male", "faction/rebel/tatooine_trooper_a", "factional/common/trooper", "default") --Equip, Skill, Customization
	SceneObject(pNpc):setCustomObjectName("Alliance Soldier")

	...
	manifest = {
		{
			...
			items = {
				...
				--{template = "object/tangible/deed/pet_deed/gurreck_deed.iff", cost = 10, max = 10, chance = 100, overridePrice = true, isMount = false},
				--{template = "object/tangible/deed/pet_deed/rancor_deed.iff", cost = 10, max = 10, chance = 100, overridePrice = true, isMount = false},
			}
		},
	}	
}
